    ...
    <div className='bg-neutral-900 min-h-screen flex items-center'>
      <div className='px-10 container m-auto'>
        <div className='flex items-center justify-center'>
          <div className='bg-zinc-800 pt-5 px-10 shadow-md shadow-black rounded-lg overflow-hidden'>
            <header className='flex justify-between items-center py-4 text-white'>
              <h3 className='text-xl'>Nuevo producto</h3>
              <Link to='/backend' className='text-gray-400 text-sm hover:text-red-600'>Salir</Link>
            </header>
          ...
          >
            {({handleSubmit, setFieldValue, isSubmitting}) => (
              <Form onSubmit={handleSubmit} className='flex justify-center flex-col items-center'>
                <div>
                  <label htmlFor='name' className='text-sm block font-bold text-gray-400'>Nombre</label>
                  ...
                  <label htmlFor='description' className='text-sm block font-bold text-gray-400'>Descripción</label>
                  ...
                  <label htmlFor='price' className='text-sm block font-bold text-gray-400'>Precio</label>
                  ...
                  <label htmlFor='image' className='text-sm block font-bold text-gray-400'>Imagen</label>
                  ...
                  <button disabled={isSubmitting} className='bg-indigo-600 hover:bg-indigo-500 w-full py-2 rounded my-8 text-white focus:outline-none disabled:bg-indigo-400' type='submit'>{isSubmitting ? (<AiOutlineLoading3Quarters className='animate-spin h-5 w-5'></AiOutlineLoading3Quarters>) : 'Save'}</button>
              </Form>
            )}
          </Formik>
          </div>
